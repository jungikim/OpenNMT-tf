...
echo "<ctc_blank>" >> ASLLRP-ASLLVD-OpenNMT-tf/ASL.vocab
...
for i in test test valid train ; do PYTHONPATH=. python opennmt/bin/video_to_tfrecord.py --vidList ASLLRP-ASLLVD-OpenNMT-tf-data/ASLLRP-ASLLVD-${i}.file --out ASLLRP-ASLLVD-OpenNMT-tf-data/${i} > ASLLRP-ASLLVD-OpenNMT-tf-data/${i}.log 2>&1 ; done &
